...
class FemtoDreamParticleHisto
{
 public:
  ...
  void init_base(std::string folderName, std::string tempFitVarAxisTitle, T& tempFitVarMomentumAxis, T& tempFitVarAxis)
  {
  ...
  // comment
  template <o2::aod::femtodreamMCparticle::MCType mc, typename T>
  void init_debug(std::string folderName, T& tempFitVarMomentumAxis, T& NsigmaTPCAxis, T& NsigmaTOFAxis, T& NsigmaTPCTOFAxis, T& InvMassAxis)
  {
    ...
    if constexpr (mParticleType == o2::aod::femtodreamparticle::ParticleType::kTrack || mParticleType == o2::aod::femtodreamparticle::ParticleType::kV0Child) {
      ...
      mHistogramRegistry->add((folderName + folderSuffix + "/hTPCsharedOverFound").c_str(), "; TPC ratio shared over found; Entries", kTH1F, {{100, 0, 1}});
      mHistogramRegistry->add((folderName + folderSuffix + "/hTPCsharedOverCrossedRows").c_str(), "; TPC ratio shared over found; Entries", kTH1F, {{100, 0, 1}});
      mHistogramRegistry->add((folderName + folderSuffix + "/hTPCPtVsShared").c_str(), ";p_{T} (GeV/c) ; TPC shared clusters", kTH2F, {{500, 0, 10}, {163, -0.5, 162.5}});
      ...
      mHistogramRegistry->add((folderName + folderSuffix + "/hTPCcrossedRowsVsShared").c_str(), ";TPC found clusters ; TPC shared clusters;", kTH2F, {{163, -0.5, 162.5}, {163, -0.5, 162.5}});
      mHistogramRegistry->add((folderName + folderSuffix + "/hTPCchi2NCl").c_str(), ";TPC chi2 over clusters ; Entries", kTH1F, {{500, 0, 5}});
      ...
      mHistogramRegistry->add((folderName + folderSuffix + "/hPtVsChi2NCl").c_str(), ";p_{T} (GeV/c) ; TPC chi2 over clusters;", kTH2F, {{500, 0, 10}, {500, 0, 5}});
      mHistogramRegistry->add((folderName + folderSuffix + "/hITSclusters").c_str(), "; ITS clusters; Entries", kTH1F, {{10, -0.5, 9.5}});
      mHistogramRegistry->add((folderName + folderSuffix + "/hPtVsITSclusters").c_str(), ";p_{T} (GeV/c) ; ITS clusters;", kTH2F, {{500, 0, 10}, {10, -0.5, 9.5}});
      mHistogramRegistry->add((folderName + folderSuffix + "/hITSclustersIB").c_str(), "; ITS clusters in IB; Entries", kTH1F, {{10, -0.5, 9.5}});
      mHistogramRegistry->add((folderName + folderSuffix + "/hPtVsITSclustersIB").c_str(), ";p_{T} (GeV/c); ITS clusters in IB;", kTH2F, {{500, 0, 10}, {10, -0.5, 9.5}});
      mHistogramRegistry->add((folderName + folderSuffix + "/hITSclustersVsITSclustersIB").c_str(), ";ITS clusters; ITS clusters in IB;", kTH2F, {{10, -0.5, 9.5}, {10, -0.5, 9.5}});
  ...
  void init(HistogramRegistry* registry, T& MomentumBins, T& tempFitVarBins, T& NsigmaTPCBins, T& NsigmaTOFBins, T& NsigmaTPCTOFBins, T& InvMassBins, bool isMC, int pdgCode, bool isDebug = false)
  {
    ...
    if (registry) {
      ...
      init_base<o2::aod::femtodreamMCparticle::MCType::kRecon>(folderName, tempFitVarAxisTitle, tempFitVarMomentumAxis, tempFitVarAxis);
      if (isDebug) {
        init_debug<o2::aod::femtodreamMCparticle::MCType::kRecon>(folderName, tempFitVarMomentumAxis, NsigmaTPCAxis, NsigmaTOFAxis, NsigmaTPCTOFAxis, InvMassAxis);
      }
      if (isMC) {
        init_base<o2::aod::femtodreamMCparticle::MCType::kTruth>(folderName, tempFitVarAxisTitle, tempFitVarMomentumAxis, tempFitVarAxis);
  ...
  void fillQA_debug(T const& part, aod::femtodreamparticle::MomentumType MomentumType)
  {
    ...
    if constexpr (mParticleType == o2::aod::femtodreamparticle::ParticleType::kTrack || mParticleType == o2::aod::femtodreamparticle::ParticleType::kV0Child) {
      ...
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hTPCsharedOverCrossedRows"), static_cast<float>(part.tpcNClsShared()) / static_cast<float>(part.tpcNClsCrossedRows()));
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hTPCPtVsShared"), part.pt(), part.tpcNClsShared());
      ...
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hTPCcrossedRowsVsShared"), part.tpcNClsCrossedRows(), part.tpcNClsShared());
      ...
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hPtVsChi2NCl"), part.pt(), part.tpcChi2NCl());
      ...
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hPtVsITSclusters"), part.pt(), part.itsNCls());
      ...
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hPtVsITSclustersIB"), part.pt(), part.itsNClsInnerBarrel());
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hITSclustersVsITSclustersIB"), part.itsNCls(), part.itsNClsInnerBarrel());
      ...
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hpTInvMassLambda"), momentum, part.mLambda());
      ...
      mHistogramRegistry->fill(HIST(o2::aod::femtodreamparticle::ParticleTypeName[mParticleType]) + HIST(mFolderSuffix[mFolderSuffixType]) + HIST(o2::aod::femtodreamMCparticle::MCTypeName[mc]) + HIST("/hpTInvMassAntiLambda"), momentum, part.mAntiLambda());
